IM_NAME=ipbalfredo/hesai-node:humble
CONT_NAME=hesai-ros2-node-container # You will need to apply the exact same name to container_name in orb-container/docker-compose.yml
